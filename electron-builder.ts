...
const config: Configuration = {
	...
	mac: {
		...
		extendInfo: {
			...
			NSLocalNetworkUsageDescription:
				"Kairo needs access to your local network to discover and connect to development servers running on your network.",
			...
			NSAppleEventsUsageDescription:
				"Kairo needs to interact with other applications to run terminal commands and development tools.",
		},
	},
	...
	linux: {
		...
		target: ["AppImage"],
		artifactName: `kairo-\${version}-\${arch}.\${ext}`,
	},
